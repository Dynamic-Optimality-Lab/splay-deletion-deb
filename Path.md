...
**Exact commit/hash at which SA-03 became frozen:** freeze commit hash recorded post-commit (SA-02 precedent: placeholder here, hash in §22 final report / next execution step); file hashes: SA-03 `BB407FAC…17E25E1`, prereg `FCE7F8C0…365BD73`, WorkPlan v0.1.7 (header; full hash in final report), schemas post-n7-candidate + n8-holdout (ledger), firewall `python/n8_holdout/*` (new package; SA-02 firewall untouched).
